...
class MainScr(Screen):
    def __init__(self, **kwargs):
        ...
        vl.add_widget(ScrButton(self, direction='down', goal ='first', text = '1', color = 'af479e'))
        vl.add_widget(ScrButton(self, direction='left', goal ='second', text = '2', pos_hint = {'left':2}))
        vl.add_widget(ScrButton(self, direction='up', goal ='third', text = '3', size_hint = (.1, 1)))
